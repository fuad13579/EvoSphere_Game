...
namespace EvoSphere
{
    std::array<Tile, BOARD_SIZE> createBoardTiles()
    {
        return {
            ...
            Tile{33, TileType::WildEvoran, ElementType::Dark, "Dark", "Voidmar", true},
            Tile{34, TileType::WildEvoran, ElementType::Mystic, "Mystic", "Auramind", true},
            Tile{35, TileType::Teleport, ElementType::None, "", "", false},
            Tile{36, TileType::ChaosRift, ElementType::None, "", "", false},
            Tile{37, TileType::WildEvoran, ElementType::Mystic, "Mystic", "Runelith", true},
            Tile{38, TileType::SpecialOwnable, ElementType::None, "Relic", "Ancient Relic Shrine", true},
            Tile{39, TileType::WildEvoran, ElementType::Dark, "Dark", "", true}
        };
    }
